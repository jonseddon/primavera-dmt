#!/usr/bin/env python
"""
update_dreqs_0106.py

This script creates new source_ids for AWI and updates existing coupled
...
def main(args):
    ...
    Main entry point
    """
    lr = ClimateModel.objects.create(short_name='AWI-CM-1-1-LR',
                                     full_name='AWI-CM-1-1-LR')
    hr = ClimateModel.objects.create(short_name='AWI-CM-1-1-HR',
                                     full_name='AWI-CM-1-1-HR')
