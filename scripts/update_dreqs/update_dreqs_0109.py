#!/usr/bin/env python
"""
update_dreqs_0109.py

This script moves the highres-future data requests from HadGEM3-GC31-LM to
HadGEM3-GC31-LL.
"""
import argparse
...
def main(args):
    ...
    Main entry point
    """
    low_res = ClimateModel.objects.get(short_name='HadGEM3-GC31-LL')
    ...
    data_reqs.update(climate_model=low_res)
