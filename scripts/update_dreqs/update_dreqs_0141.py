#!/usr/bin/env python
"""
update_dreqs_0141.py

This file updates all CERFACS highres-future and highresSST-future
...
def main(args):
    ...
    logger.debug('{} affected requests found'.format(future.count()))

    future.update(rip_code='r1i1p1f2')
