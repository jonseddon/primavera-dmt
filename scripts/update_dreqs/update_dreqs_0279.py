...
This file creates data requests for a few variables from MOHC -MH hist-1950,
control-1950 and highres-future.
"""
import argparse
...
def main(args):
    ...
    vars = [
        {'variable_request__table_name': 'Amon',
         'variable_request__cmor_name__in': ['ta', 'pr', 'ua', 'va', 'zg',
                                             'hfss', 'hfls']},
        {'variable_request__table_name': 'day',
         'variable_request__cmor_name__in': ['pr', 'psl']},
        {'variable_request__table_name': 'Omon',
         'variable_request__cmor_name__in': ['tos', 'zos']}
    ]
