#!/usr/bin/env python
"""
update_dreqs_0148.py

Create a custom retrieval request for Jon so that ESMValTool can be run on the
AMIP data.
"""
...
def main(args):
    ...
    drs = DataRequest.objects.filter(
        ...
        variable_request__table_name__in=['Amon', 'LImon', 'SImon'],
        variable_request__cmor_name__in=['tas', 'ts', 'pr', 'psl', 'snd',
                                         'siconc']
    )
