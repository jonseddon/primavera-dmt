#!/usr/bin/env python
"""
update_dreqs_0232.py

Create data requests for EC-Earth3P both resolutions spinup-1950 r1i1p2f1.
"""
...
def main(args):
    ...
    source_ids = ['EC-Earth3P', 'EC-Earth3P-HR']
    clim_models = [ClimateModel.objects.get(short_name=si)
                   for si in source_ids]

    logger.debug('{} r1i1p1f1 data requests found'.
