#!/usr/bin/env python
"""
update_dreqs_0266.py

Update the tracking_id of EC-Earth Lmon and LImon datasets
...
import django
django.setup()
from pdata_app.utils.common import run_command
...
def main(args):
    ...
    for dataset in datasets:
        ...
        directory = dreq.directories()[0]
        force_fix = ('/home/users/jseddon/primavera/pre-proc/bin/'
                     'run_force_fix.sh')
        run_command(f'{force_fix} {directory} TrackingIdNew')
