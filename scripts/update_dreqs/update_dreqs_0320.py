#!/usr/bin/env python
"""
update_dreqs_0320.py

ESGF AttributeUpdate
Called from a Rose suite to update the filename in CMCC highresSST-present
6 hourly datasets.
"""
import argparse
...
from pdata_app.utils.attribute_update import CorrectFileNameUpdate  # nopep8
...
def main(args):
    ...
    for data_file in dreq.datafile_set.order_by('name'):
        ...
        updater = CorrectFileNameUpdate(data_file)
        updater.update()
