#!/usr/bin/env python
"""
update_dreqs_0095.py

This file removes 12 HadGEM3-GC31-HM r1i3p1f1 AMIP files for 2012.
"""
import argparse
...
def main(args):
    ...
    Main entry point
    """
    amip_2012 = DataFile.objects.filter(
    ...
    logger.debug('HM r1i3p1f1 2012 {} affected files found'.
                 format(amip_2012.count()))
    delete_files(amip_2012)
