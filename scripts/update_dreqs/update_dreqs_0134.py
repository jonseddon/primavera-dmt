#!/usr/bin/env python
"""
update_dreqs_0134.py

Create data requests for HadGEM3-GC31-LL highres-future r1i[23]p1f1.
"""
...
def main(args):
    ...
    logger.debug('{} r1i1p1f1 data requests found'.format(i1_dreqs.count()))
