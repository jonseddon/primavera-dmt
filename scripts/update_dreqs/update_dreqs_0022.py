...
"""
update_dreqs_0022.py

This file adds data and variable requests for CNRM for both models for all the
experiments.
"""
...
def main(args):
    ...
    Main entry point
    """
    # new_vreqs = ['sisnthick_SIday', 'sitemptop_SIday', 'wo_Omon']
    ...
    new_vreqs = [
        {'table_name': 'Primday',
         ...
         'uid': '8b983136-4a5b-11e6-9cd2-ac72891c3257'},
        {'table_name': 'Primday',
         'long_name': 'Geopotential Height',
         'units': 'm',
         'var_name': 'zg',
         ...
         'frequency': 'day',
         'cell_measures': 'area: areacella',
         'uid': 'abbb60e8-817c-11e6-a4e2-5404a60d96b5'},
    ]
