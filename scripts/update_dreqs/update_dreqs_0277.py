#!/usr/bin/env python
"""
update_dreqs_0277.py

Remove from the DMT the CMCC rlut, rlutcs and rsutcs variables from
highres-future, highresSST-future and hist-1950 that have been fixed.
"""
import argparse
