#!/usr/bin/env python
"""
update_dreqs_0196.py

Replace all files in the submission /gws/nopw/j04/primavera1/WP6/stream2/
transient/HighResMIP/EC-Earth-Consortium/EC-Earth3P/hist-1950/r3i1p2f1/freq_mon
as this is a duplicate of another submission.
"""
import argparse
...
def main(args):
    ...
    Main entry point
    """
    affected_files = DataSubmission.objects.get(
        incoming_directory=
        '/gws/nopw/j04/primavera1/WP6/stream2/transient/HighResMIP/'
        'EC-Earth-Consortium/EC-Earth3P/hist-1950/r3i1p2f1/freq_mon',
    ).datafile_set.all()
