#!/usr/bin/env python
"""
update_dreqs_0075.py

This file removes all CERFACS AMIP files from versions v20170622 and v20170614
for realization r1i1p1f1.
"""
import argparse
...
def main(args):
    ...
    Main entry point
    """
    orig_amip = DataFile.objects.filter(
        institute__short_name='CNRM-CERFACS',
        experiment__short_name='highresSST-present',
        version__in=['v20170614', 'v20170622'],
        rip_code='r1i1p1f1'
    )
    logger.debug('{} affected files found'.format(orig_amip.count()))
    delete_files(orig_amip)
    replace_files(orig_amip)
